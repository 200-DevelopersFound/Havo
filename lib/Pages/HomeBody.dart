...
class HomeBody extends StatefulWidget {
  final Function() screenOrientationUpdate;
  const HomeBody({required this.screenOrientationUpdate, Key? key})
      : super(key: key);
                ...
                BlurredCard(
                    ...
                    onTap: () {
                      Navigator.push(context,
                        ...
                        setState(() {});
                        widget.screenOrientationUpdate.call();
                      });
                    }),
                SizedBox(
                  width: 10,
              ...
              children: [
                Container(
                  ...
                  child: Text(
                    'Add Category',
                    style:
                        GoogleFonts.oswald(color: Colors.white, fontSize: 22),
                  ),
                ),
                TextField(
